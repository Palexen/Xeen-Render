   ...
   static void Init()
   {
    ...
    void OnGUI()
    {
        Texture icon = EditorGUIUtility.isProSkin ? AssetDatabase.LoadAssetAtPath<Texture>
            ("Packages/com.xeenrender.tools/Editor Default Resources/terrain_exporter_pro.png") 
            : AssetDatabase.LoadAssetAtPath<Texture>
            ("Packages/com.xeenrender.tools/Editor Default Resources/terrain_exporter_light.png");

        this.titleContent = new GUIContent("Terrain Exporter", icon);
        ...
        if (!terrain)
        {
            ...
            {
                GUILayout.Box("No Terrain Found", cyanBox, GUILayout.Height(30));
            }
            else
            {
                GUILayout.Box("No Terrain Found", darkBox, GUILayout.Height(30));
            }
            GUILayout.FlexibleSpace();
            if (GUILayout.Button("Cancel", PalexenEditorStyles.BigButton))
            {
        ...
        if (EditorGUIUtility.isProSkin)
        {
            GUILayout.Box("Select a mesh export mode", cyanBox, GUILayout.Height(30));
        }
        else
        {
            GUILayout.Box("Select a mesh export mode", darkBox, GUILayout.Height(30));
        }
        ...
        if (EditorGUIUtility.isProSkin)
        {
            GUILayout.Box("Select your export resulution", cyanBox, GUILayout.Height(30));
        }
        else
        {
            GUILayout.Box("Select your export resulution", darkBox, GUILayout.Height(30));
        }
        saveResolution = (SaveResolution)EditorGUILayout.EnumPopup("Resolution", saveResolution);

        GUILayout.Space(25);
        GUILayout.FlexibleSpace();
        if (GUILayout.Button("Export", PalexenEditorStyles.BigButton))
        {
            Export();
        }
    }
